...
### 解答
 1. [https://blog.csdn.net/gol_phing/article/details/49032055]
 2. [http://blog.jobbole.com/114009/](http://blog.jobbole.com/114009/)  
 3. execute(Runnable x) 没有返回值。可以执行任务，但无法判断任务是否成功完成。 submit(Runnable x) 返回一个future。可以用这个future来判断任务是否成功完成。
  4.  [https://segmentfault.com/a/1190000016611415](https://segmentfault.com/a/1190000016611415)  5
  5.  
  6.  [https://blog.csdn.net/bug_moving/article/details/55803458] 
  7.
